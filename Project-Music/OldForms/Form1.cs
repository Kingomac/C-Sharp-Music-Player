...
namespace Project_Music
{
    public partial class Form1 : Form
    {
        ...
        {
            if (TimeTrackBar.Value - 150 >= 150) TimeTrackBar.Value -= 150;
            else
            {
                reloj.Stop(); 
            }
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            if (isPlaying)
            {
                audio.Position = 1000 * TimeTrackBar.Value;
            }
        }
        ...
        private void TimeTrackBar_Scroll(object sender, ScrollEventArgs e)
        {
            audio.Position = TimeTrackBar.Value * 1000;
        }
    }
}